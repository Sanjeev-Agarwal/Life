...
namespace Life.API
{
    class Rule
    {
        ...
        {
            var liveNeighbourCount = CountAliveNeighbours(inputGrid, coOrdinates);
            lock (outputGrid)
            {
                if (HasAliveInNextState(inputGrid[coOrdinates.X, coOrdinates.Y], liveNeighbourCount))
                {
        ...
        private static int CountAliveNeighbours(Grid grid, CoOrdinates coOrdinates)
        {
            ...
            CellType enumInnerCell = RuleHelper.GetCellType(grid, coOrdinates);
            ...
            return reachableCells.Sum(coOrds => HasAliveNeighbour(grid, coOrdinates, coOrds));
        }
        ...
        private static int HasAliveNeighbour(Grid grid, CoOrdinates baseCoOrdinates, CoOrdinates offSetCoOrdinates)
        {
